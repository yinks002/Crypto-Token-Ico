...
import {TiSocialFacebook, TiSocialTwitter, 
  TiSocialLinkedin, TiSocialInstagram,
   TiSocialGithub} from "react-icons/ti";
...
<div className="container">
    <div className="row mt-none-30">
      <div className="col-lg-4 mt-30">
        <div className="footer__widget footer__subscribe">
            ...
            <p>Lorem ipsum dolo
                r, sit 
                amet consectetur adipisicing elit. Iusto, rers n
                on est explicabo culpa facere tempore distincti
                o porro similique 
                !</p>
                <form action=""> 
                  <input type="text" placeholder="Register for the yinksToken newsLetter"/>
                    <button>
                        <IoIosSend/>
                    </button>
                </form>
    ...
    <div className="footer__wiget text-lg-end">
    ...
    <div className="container">
      <div className="footer__copyright-inner ul_li_between">
        <div className="footer__copyright-text mt-15">
            copyright @ 2024 yinks002 All rights reserved
        </div>
